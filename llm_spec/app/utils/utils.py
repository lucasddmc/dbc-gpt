...
class Utils:
    ...
    @staticmethod
    def build_initial_prompt(erc_standard: str, verifier: str) -> str:
        ...
        # Load code examples for the ERC standard
        example_path = os.path.join('app', 'assets', 'examples', f'{erc_standard.upper()}_example.sol')
        with open(example_path, 'r') as f:
            code_example = f.read()

        # Load the contract template for the ERC standard
        contract_template_path = os.path.join('app', 'assets', 'contracts', f'{erc_standard.upper()}_contract_template.sol')
        with open(contract_template_path, 'r') as f:
            contract_template = f.read()

        # Load the EIP markdown for the ERC standard
        eip_path = os.path.join('app', 'assets', 'eips', f'{erc_standard.upper()}_eip.md')
